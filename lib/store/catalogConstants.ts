/**
 * İstemci ve sunucu için paylaşılan mağaza sabitleri ve başlangıç kataloğu.
 * Bu dosya saf TypeScript sabitleri içerir; Prisma veya DB bağımlılığı yoktur.
 */

import { StoreItemDto } from "@/components/dashboard/stages/store/StoreItemCard";
...
export const INITIAL_STORE_ITEMS: StoreItemDto[] = [
  {
