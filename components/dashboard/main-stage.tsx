...
export function MainStage({ onStartRanked, onOpenCustomRoom }: MainStageProps) {
  ...
  return (
    <section className="relative flex flex-1 flex-col justify-between overflow-hidden bg-[#f4f7f5] text-[#141b16] select-none font-sans p-8 lg:p-12">
      ...
      {/* 2. Merkez Mimari Saha Çizgileri (UEFA / Premier League Editoryal Geometri) */}
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-7 lg:gap-10 w-full max-w-5xl">
          {/* 1. Ortak Oyuncu Modu (Aktif / Seçili Kart) */}
          <div
          ...
          >
            ...
            {/* Sub-modes selector directly under Ortak Oyuncu (Tactile Segmented Control) */}
              ...
              {subModes.map((sub) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full h-[46px] flex items-center justify-between px-3.5 rounded-xl border text-left transition-all ${
                      isSubActive
          ...
          {/* 2. Millet-Takım Modu (Showcase Kartı) */}
          <div
          ...
          >
            {/* Top Bar: Tag & Question Mark Button */}
            <div className="w-full flex items-center justify-between mb-4">
          ...
          {/* 3. Müzayede Modu (Showcase Kartı) */}
          <div
      ...
      <div className="relative z-10 flex justify-center pt-5">
        {selectedModeId === "common_player" ? (
          <button
            ...
            className="relative group flex items-center justify-center transition-transform active:scale-[0.98] w-[340px] h-[62px]"
          >
        ...
        >
          ...
          >
            ...
            <div className="flex items-start justify-between pb-4 border-b border-[#e2e8e4]">
              ...
              <button
                onClick={() => setActiveGuideKey(null)}
                className="flex size-8 items-center justify-center rounded-full text-[#6b7770] hover:bg-[#f0f4f2] hover:text-[#141b16] transition-colors"
              >
                <X className="size-5" />
              </button>
            </div>

            {/* Visual Media Placeholder Box (Video / GIF Alanı) */}
            ...
            <div className="mt-5 flex justify-end">
              <button
                onClick={() => setActiveGuideKey(null)}
                className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-[#15803d] text-white text-xs font-black uppercase tracking-wider shadow-sm hover:bg-[#15803d]/90 active:scale-95 transition-all"
              >
                Anladım
              </button>
            </div>
